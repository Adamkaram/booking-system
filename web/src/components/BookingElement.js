...
function BookingElement({
  ...
  const startTime = momentTimezone.tz(bookingData.bookingStart, 'Africa/Cairo').format('h.mma')
  const endTime = momentTimezone.tz(bookingData.bookingEnd, 'Africa/Cairo').format('h.mma')
