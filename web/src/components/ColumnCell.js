...
const ColumnCell = (props) => {
  ...
  if (typeof bookingData == "number") {
    ...
    // If there is a booking object, but only for the first half of the hour,
    //return a nested table to split the table data for that cell into two rows.
    ...
    // If there is a booking object, but only for the second half of the hour,
    //return a nested table to split the table data for that cell into two rows
