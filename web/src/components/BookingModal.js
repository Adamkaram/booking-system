    ...
    <ReactModal
      ...
      {!!props.selectedBooking && (
        <div className="modal__boday">
          ...
          <p className="modal__paragraph">
            {`${momentTimezone
              .tz(props.selectedBooking["bookingStart"], "Africa/Cairo")
              .format("h.mma")} to ${momentTimezone
              .tz(props.selectedBooking["bookingEnd"], "Africa/Cairo")
              .format("h.mma")}`}
            <p className="modal__paragraph">
              {`${momentTimezone
                .tz(props.selectedBooking["bookingStart"], "Africa/Cairo")
          ...
          <p className="modal__paragraph">
            ...
            {props.selectedBooking["businessUnit"]}
          </p>
          <p className="modal__paragraph">
      ...
      <a href={`mailto:${props.user}`} className="button">
        Contact
      </a>
